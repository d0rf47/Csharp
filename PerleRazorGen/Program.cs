...
namespace Perle.com.RazorGen
{
    public class RazorGen
    {
        ...
        public readonly string OutpuTFileDir = @"C:\Users\MichaelFalconi\Desktop\websites\perlesystems.it\perlesystems.it\Views\Products\allproducts\industrial-power-supply";
        public readonly string InputFileDir = @"C:\Users\MichaelFalconi\Downloads\perlewebsites\perlesystems.it\perlesystems.it\products\industrial-power-supply";
        ...
        private readonly string templateMcrDemoBtn = "<main>\n\r    <div class=\"container productPageCard\">\n\r        <partial name=\"../Shared/ProductPages/_productHeader\" model=\"@Model\" view-data='new ViewDataDictionary(ViewData) { { \"btn\", new Button(\"Demo\", \"/contactus/mcrdemo\", \"fas fa-play\") }}' />\n\r        <div class=\"container-fluid px-xs-0\">\n\r            <partial name=\"../Shared/ProductPages/_tabs\" model=\"@Model\" />\n\r            <div class=\"tab-content print-only\" id=\"productTabs\">\n\r                \n\r            <partial name=\"../Shared/ProductPages/_tabsContent\"\n\r                     model=\"@Model\" />\n\r            </div>\n\r        </div>    \n\r    </div>\n\r</main>\n\r\n\r<partial name=\"../Shared/ProductPages/_productModal\" />\n\r@section meta {\n\r    <partial name=\"_metaContent\" model=\"Model.MetaData\" />\n\r}\n\r@section css {\n\r    <link rel=\"stylesheet\" href=\"~/css/productPage.css\" asp-append-version=\"true\" preload as=\"style\">\n\r}\n\r\n\r@section scripts {\n\r    <script src=\"~/js/productsCommon.js\" asp-append-version=\"true\" async></script>\n\r    <script src=\"~/dist/partNumbersFilterScript.entry.js\" asp-append-version=\"true\" async></script>\n\r}\n\r";
        private readonly string templateIOLANDemoBtn = "<main>\n\r    <div class=\"container productPageCard\">\n\r        <partial name=\"../Shared/ProductPages/_productHeader\" model=\"@Model\" view-data='new ViewDataDictionary(ViewData) { { \"btn\", new Button(\"Demo Now\", \"/contactus/iolandemo\", \"fas fa-play\") }}' />\n\r        <div class=\"container-fluid px-xs-0\">\n\r            <partial name=\"../Shared/ProductPages/_tabs\" model=\"@Model\" />\n\r            <div class=\"tab-content print-only\" id=\"productTabs\">\n\r                \n\r            <partial name=\"../Shared/ProductPages/_tabsContent\"\n\r                     model=\"@Model\" />\n\r            </div>\n\r        </div>    \n\r    </div>\n\r</main>\n\r\n\r<partial name=\"../Shared/ProductPages/_productModal\" />\n\r@section meta {\n\r    <partial name=\"_metaContent\" model=\"Model.MetaData\" />\n\r}\n\r@section css {\n\r    <link rel=\"stylesheet\" href=\"~/css/productPage.css\" asp-append-version=\"true\" preload as=\"style\">\n\r}\n\r\n\r@section scripts {\n\r    <script src=\"~/js/productsCommon.js\" asp-append-version=\"true\" async></script>\n\r    <script src=\"~/dist/partNumbersFilterScript.entry.js\" asp-append-version=\"true\" async></script>\n\r}\n\r";
        private readonly string templatePowerSupFilterBtn = "<main>\n\r    <div class=\"container productPageCard\">\n\r        <partial name=\"../Shared/ProductPages/_productHeader\" model=\"@Model\" view-data='new ViewDataDictionary(ViewData) { { \"btn\", new Button(\"Filtro e Ricerca Alimentatori\", \"/product-selector/power-supply/\", \"fas fa-filter\") }}' />\n\r        <div class=\"container-fluid px-xs-0\">\n\r            <partial name=\"../Shared/ProductPages/_tabs\" model=\"@Model\" />\n\r            <div class=\"tab-content print-only\" id=\"productTabs\">\n\r                \n\r            <partial name=\"../Shared/ProductPages/_tabsContent\"\n\r                     model=\"@Model\" />\n\r            </div>\n\r        </div>    \n\r    </div>\n\r</main>\n\r\n\r<partial name=\"../Shared/ProductPages/_productModal\" />\n\r@section meta {\n\r    <partial name=\"_metaContent\" model=\"Model.MetaData\" />\n\r}\n\r@section css {\n\r    <link rel=\"stylesheet\" href=\"~/css/productPage.css\" asp-append-version=\"true\" preload as=\"style\">\n\r}\n\r\n\r@section scripts {\n\r    <script src=\"~/js/productsCommon.js\" asp-append-version=\"true\" async></script>\n\r    <script src=\"~/dist/partNumbersFilterScript.entry.js\" asp-append-version=\"true\" async></script>\n\r}\n\r";
            ...
            Directory.GetFiles(OutpuTFileDir, "*").ToList().ForEach(entry =>
            {
                if (!entry.Contains("Index") && !entry.Contains("assets") && !entry.Contains("techspecs") && !entry.Contains(".aspx") && !entry.Contains(".xml"))
                {
                    ...
                    {                        
                        ...
                        if(oldHtml.Contains("InstanceBegin template = datasheet-page"))            
                        {
                            if(oldHtml.Contains("/contactus/mcrdemo") || oldHtml.Contains("/contactus/media_converter_demo"))
